...
<body style="background-color: #2e2e2e">
    ...
    <div class="cookie-container">
        <p>
            Kliknutím na "Súhlasím" vyjadrujete súhlas s používaním súborov cookie na našom webe, na sociálnych médiách
            a na
    ...
    <main>
        <section class="home">
            ...
            <div class="home-content">
                ...
                <p>Scuderia Ferrari je taliansky automobilový tím formuly 1, ktorý založil Enzo Ferrari v roku 1929 v
                    mestečku
                    Maranello. (Scuderia znamená stajňa.) Súčasným prezidentom pretekárskeho oddelenia spoločnosti
                    Ferrari je
                    Louis Camilleri.

                    Symbolom Ferrari je čierny vzpínajúci sa kôň na žltom poli. Scuderia Ferrari pretekala od svojho
                    založenia až
                    do roku 1939 (10 rokov) pre značku Alfa Romeo a až v roku 1948 sa objavuje na pretekoch formuly 1
                    ako značka
                    Ferrari s vozidlom F 125.

                    História stajne je fascinujúca a Scuderia Ferrari je so ziskom 15. titulov majstra sveta formuly 1 a
                    16.
                    titulov Majstrovstiev sveta konštruktérov F1 najúspešnejším tímom.</p><br>
                <h1>Úspechy ferrari</h1><br>
                <h3>2004</h3>
                <p>
                    Roky 2000 až 2004 boli úplne v znamení dominancie tímu Ferrari a Michaela Schumachera, ktorému po
                    celú túto
                    dobu stál po boku tímový kolega Rubens Barrichello. Úplne vypovedajúcim výsledkom je päť jazdeckých
                    a päť
                    konštruktérskych titulov za víťazstvo v majstrovstvách sveta. Počas týchto rokov Ferrari aj Michael
                    Schumacher
                    znateľne prekonali mnoho rekordov formuly 1, od počtu majstrovských titulov, cez počet víťazstiev v
                    grand
                    prix, kvalifikáciách, počet najrýchlejších kôl až po neprerušené série vyhraných pretekov či
                    pretekov na
                    stupňoch víťazov.
                </p>
                <h3>2007</h3><br>
                <p>
                    Do tímu prišiel miesto Michalea Schumachera Kimi Räikkonen od McLarenu, Felipe Massa v tíme
                    pokračoval po jeho
                    boku. Nové vozidlo bolo tajne odhalené, bez pozvania fotografov, 14. januára a hneď na druhý deň sa
                    pokračovalo v testovaní. Počas predsezónneho testovania sa nové vozidlo F2007 rýchlo zlepšovalo a
                    bolo vždy na
                    čele pri rôznych spoločných testoch všetkých tímov formuly 1. Na konci sezóny vyhral Kimi Raikkonen
                    šampionát
